(function() {
    ...
    /** @ngInject */
    function CustomerGroupService($resource, toastr, CommonService) {

        var rest = $resource('api/customer-group/:id', {}, {
            'create': { method: 'POST' },
            'update': { method: 'PUT' },
        });

        function getSmartData(param, callback) {
            $resource('api/customer-group/getSmartData', {}, {
                'query': { method: 'POST' }
            }).query(param,
                function(data) {
                    console.log(data);
        ...
        function getList(param, callback) {
            $resource('api/customer-group/getlist').get(param,
                function(data) {
                    console.log(data);
                    callback(data);
                },
