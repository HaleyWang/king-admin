(function() {
    ...
    /** @ngInject */
    function MarketService($resource, toastr, CommonService) {

        var rest = $resource('api/market/:id', {}, {
            'create': { method: 'POST' },
            'update': { method: 'PUT' },
        });

        function getSmartData(param, callback) {
            $resource('api/market/getSmartData', {}, {
                'query': { method: 'POST' }
            }).query(param,
                function(data) {
                    console.log(data);
        ...
        function getList(param, callback) {
            $resource('api/market/getlist').get(param,
                function(data) {
                    console.log(data);
                    callback(data);
                },
